...
EXCLUDE_PATH_RE='(^|/)(node_modules|vendor|dist|build|out|\.next|coverage|visual-tests|e2e|tests|test|__tests__|\.git)(/|$)'
GENERATED_RE='(^|/)(alembic[^/]*/versions|migrations)(/|$)'
EXCLUDE_NAME_RE='(^test_.+|.+_test\..+|.+\.test\..+|.+\.spec\..+|.+\.d\.ts|conftest\.py)$'
